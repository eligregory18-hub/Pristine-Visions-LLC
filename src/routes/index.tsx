...
const faqs = [
  {
    ...
    a: "We use a professional water-fed pole connected to a RO/DI system that purifies water to 0 TDS. Resulting in crystal clear windows that are spotless, streak-free glass, with no leftover residue!",
  },
  {
